...
function addReservationToTable(reservations) {
  ...
  */
  reservations.forEach((item) => {
    ...
    const formatedDate = new Date(item.date).toLocaleDateString("en-IN");
    const formatedTime = new Date(item.time).toLocaleString("en-IN", {
      year: "numeric",
      day: "numeric",
      month: "long",
      hour: "numeric",
    ...
    const button = `
      <div class="reservation-visit-button" id=${item.id}>
